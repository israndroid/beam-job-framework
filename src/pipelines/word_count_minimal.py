...
def main(argv=None, save_main_session=True):
  ...
  with beam.Pipeline(options=pipeline_options) as p:
    utils.print_info(pipeline_options, 'pipeline_options')
    utils.print_info(known_args, 'known_args')
    utils.print_info(pipeline_args, 'pipeline_args')
...
def hello_world():
    print('Hello World from word_count_minimal.pys')
    return True
